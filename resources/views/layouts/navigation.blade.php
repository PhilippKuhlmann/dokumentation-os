<nav class="fixed top-0 z-50 w-full bg-sdarkblue dark:bg-gray-800 ">
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="/" class="flex ml-2 md:mr-24">
                    <x-svg.logo class="h-8 w-8 mr-3 fill-gray-100" />
            ...
            <div class="flex items-center">
                <div class="flex items-center ml-3">
                    <button id="theme-toggle" type="button" class="mr-3 text-gray-100 dark:text-gray-400 hover:bg-blue-800 dark:hover:bg-gray-700 focus:outline-none focus:ring-1 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5">
