        ...
        <div class="flex items-center justify-between">
            ...
            @cannot('isCustomer')
                <div class="hidden md:flex gap-1 dark:text-gray-100">
                    ...
                    <x-nav.link url="{{ route('search.utm') }}" name="UTM Suche" target="_blank"><x-svg.fire class="h-6 w-6" /> </x-nav.link>
            ...
            <div class="flex items-center">
                <div class="flex items-center ml-3">
                    <div class="w-14">
                        <button id="theme-toggle" type="button" class="mr-3 dark:text-gray-400 hover:bg-cerulean-500 dark:hover:bg-gray-700 focus:outline-none focus:ring-1 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5">
