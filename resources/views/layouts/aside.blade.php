            ...
            <ul class="space-y-2 mb-8">
                ...
                <x-aside.link href="{{ route('vm.index', $customer) }}">
                    ...
                    <div class="flex justify-between">
                        VMs
                        <span class="inline-flex items-center justify-center w-3 h-3 p-3 ml-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-gray-600 dark:text-gray-100">{{ $customer->vms()->count() }}</span>
                    </div>
                </x-aside.link>
