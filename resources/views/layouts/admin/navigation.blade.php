        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center">
                <div class="flex items-center ml-3">
                    <div class="w-14">
                        <button id="theme-toggle" type="button" class="mr-3 text-gray-500 hover:bg-gray-100 hover:text-cerulean-600 dark:text-gray-400 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 transition-colors">
